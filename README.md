...
<p></p>
<p align="justify">
欢迎访问 DockerDroid, 这是一个Docker/LXC中运行的Android云原生系统的项目。我们在多年的 Virtual Android System开发中深刻体会到，移动云操作系统方案中逆向对抗、虚拟化仿真、内核安全开发、EBPF、HOOK等技术的重要。我们目前正在着手开发新的大规模的逆向对抗系统，希望分享项目技术、项目进展和社区互动，实现Cloud Phone不断接近99.99%的仿真系统。
